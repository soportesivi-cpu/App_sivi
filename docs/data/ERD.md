...
erDiagram
    ...
    SECURE_STORE_DISCO {
        string active_domain "Guardado seguro en el celular"
        string jwt_token "Guardado seguro en el celular"
        string user_data "Guardado seguro en el celular"
        string theme_preference "Guardado seguro en el celular"
    }
